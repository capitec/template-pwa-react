    ...
    <div className="host">
      ...
      <div className="controls">
        <OmniColorField
          label="Colour"
          value={color}
          oninput={(e) => _colorChange(e)}
        />
        <OmniSelect
          label="Size"
          value={size}
          items={iconSizes as any}
          onchange={(e) => _sizeChange(e)}
        />
      </div>
    </div>
  );
