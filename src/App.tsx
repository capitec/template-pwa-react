...
const ViewOne = lazy(
  () => import(/* webpackChunkName: "module_a" */ "./modules/module-a/ViewOne")
);
const ViewTwo = lazy(
  () => import(/* webpackChunkName: "module_a" */ "./modules/module-a/ViewTwo")
);
const ViewThree = lazy(
  () =>
    import(/* webpackChunkName: "module_b" */ "./modules/module-b/ViewThree")
);

function App() {
  const _darkMediaQuery = window.matchMedia
